        ...
        <HomeLayout>
            <div className="w-full h-[90vh] flex justify-center items-center text-white">
                 <div className="w-96 h-auto p-8 rounded shadow-[0px_0px_10px_black] flex flex-col justify-start items-center space-y-3">
                      ...
                      {
                        userData?.subscription?.status==="active" || userData && (
                            <div className="w-full">
                                <button className="w-full py-2 rounded bg-red-500 hover:bg-red-600 transition ease-in-out duration-300 cursor-pointer font-bold ">Cancel Subscription</button>
                             </div>   
                        )
                      }
                 </div>
