            ...
            <div className="text-center">
                {
                    ...
                    (
                        <button className="w-48 py-2 font-bold text-md rounded-md bg-orange-500 hover:bg-orange-600 transition-all duration-300 ease-out"> Subscribe</button>

                    ):
                    (
                        <button className="w-48 py-2 font-bold text-md rounded-md bg-yellow-500 hover:bg-yellow-600 transition-all duration-300 ease-out">Watch Lectures </button>
                    )
                }
